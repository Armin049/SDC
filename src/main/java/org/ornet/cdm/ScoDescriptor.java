 ...
 * 
 * <p>Java-Klasse für ScoDescriptor complex type.
 * 
...
@XmlType(name = "ScoDescriptor", propOrder = {
    "operation"
})
    ...
    extends AbstractDeviceComponentDescriptor
{
     ...
     * {@link AbstractOperationDescriptor }
     * 
     * 
     */
    public List<AbstractOperationDescriptor> getOperation() {
        if (operation == null) {
            operation = new ArrayList<AbstractOperationDescriptor>();
        }
