 ...
 * 
 * <p>Java-Klasse für OrderDetail complex type.
 * 
...
@XmlSeeAlso({
    org.ornet.cdm.WorkflowContextState.WorkflowDetail.RequestedOrderDetail.class,
    org.ornet.cdm.WorkflowContextState.WorkflowDetail.PerformedOrderDetail.class
})
public class OrderDetail {
     ...
     * {@link PersonParticipation }
     * 
     * 
     */
    public List<PersonParticipation> getPerformer() {
        if (performer == null) {
            performer = new ArrayList<PersonParticipation>();
        }
    ...
    public List<CodedValue> getService() {
        if (service == null) {
            service = new ArrayList<CodedValue>();
        }
        return this.service;
    }
