 ...
 * 
 * <p>Java-Klasse für ClockDescriptor complex type.
 * 
...
@XmlType(name = "ClockDescriptor", propOrder = {
    "timeProtocol"
})
    ...
    extends AbstractDeviceComponentDescriptor
{
    ...
    @XmlElement(name = "TimeProtocol")
    protected List<CodedValue> timeProtocol;
     ...
     * This is why there is not a <CODE>set</CODE> method for the timeProtocol property.
     * 
     * <p>
    ...
    public List<CodedValue> getTimeProtocol() {
        if (timeProtocol == null) {
            timeProtocol = new ArrayList<CodedValue>();
        }
